        ...
        return (
            <div className="min-h-screen bg-brand-cream">
                ...
                <div className="max-w-4xl mx-auto py-20 px-4 text-center">
                    <h1 className="font-marker text-4xl text-brand-brown mb-8">Login Required</h1>
                    <p className="font-hand text-2xl text-brand-brown/70 mb-8">
                        Please log in to submit a petition or custom request.
                    </p>
                    <a href="/login" className="inline-block bg-brand-orange text-white font-marker text-xl px-8 py-4 rounded-lg transform -rotate-1 hover:-rotate-2 transition-transform border-2 border-brand-brown">
                        Go to Login
                    </a>
                </div>
                <Footer />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-4 border-2 border-brand-brown/20 rounded-xl focus:border-brand-orange outline-none font-hand text-2xl bg-brand-cream/10"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full p-4 border-2 border-brand-brown/20 rounded-xl focus:border-brand-orange outline-none font-hand text-2xl bg-brand-cream/10 md:resize-y"
